...
# 加载预训练模型和分词器
model_dir = os.path.join(BASE_DIR, 'unsloth-Qwen2-0.5B-Instruct')
...
# 加载、处理数据集和测试集
train_dataset_path = 'D:\\wk\\model\\zh_cls_fudan-news\\train.jsonl'
test_dataset_path = 'D:\\wk\\model\\zh_cls_fudan-news\\test.jsonl'
...
args = TrainingArguments(
    output_dir=os.path.join(BASE_DIR, 'output_20240820', 'Qwen2-0.5B'),
