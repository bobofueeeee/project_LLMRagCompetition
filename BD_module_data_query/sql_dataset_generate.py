from CA_common.model_client.api_request import openai_api_request
from BE_prompt.sql_generate_prompt import base_prompt
import json
import pandas as pd
import random
from CA_common.untils import extract_jsonstr
...
if __name__ == '__main__':
    ...
    # sql_seed_pair_path = "../AA_data/sql_generate_result.xlsx"
    ...
    # 批量读取问题，生成对应的sql
    sql_seed_pair_path = "../AA_data/sql_generate_result.xlsx"
    df = pd.read_excel(r'../AA_data/intent_recongnise_result.xlsx',sheet_name='未匹配到公司')
    df['sql'] = ''
    print(df)
    for i in range(len(df)):
        ...
        try:
            ...
            print(f'error: {e}')
    df.to_excel(f'../AA_data/sql_lora_result.xlsx', index=False, engine='openpyxl')
