from BD_module_data_query.sql_generate_excute_evalute import sql_excute_evalue
...
## 1.6 结果执行
## 1.7 结果评估
sql_base_path = "../AA_data/sql_seed_result.xlsx"
db_source_path = r'D:\wk\data\bs_challenge_financial_14b_dataset\dataset\博金杯比赛数据.db'
sql_evalue_path = '../AA_data/sql_generate_result.xlsx'
