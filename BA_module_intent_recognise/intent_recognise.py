from CA_common.model_client import api_request
import json
    ...
    with open(file_path, 'r', encoding='utf-8') as file:
        ...
        for line_number, line in enumerate(file, start=1):
            try:
                ...
                df_result.to_excel(f'../AA_data/intent_recongnise_result_{line_number}.xlsx', index=False, engine='openpyxl')


    df_result.to_excel(f'../AA_data/intent_recongnise_result.xlsx', index=False, engine='openpyxl')
    return df_result
